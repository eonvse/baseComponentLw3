<div>
    ...
    <x-head.page-wire class="ml-5 mt-5">Modal wire</x-head.page-wire>
        <x-button.primary>x-modal-wire</x-button.primary>
        <x-button.create>x-modal-wire.dialog</x-button.create>
        <x-button.create>x-modal-wire.dropdown</x-button.create>
        <x-button.create>x-modal-wire.inline</x-button.create>

    <x-head.page-wire class="ml-5 mt-5">Sidebar</x-head.page-wire>
        <x-button.primary>x-sidebar</x-button.primary>
        <x-button.create>x-sidebar.right</x-button.create>
